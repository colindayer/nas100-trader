...
TRACKED = [
    ...
    "broker/financing.py",
    "broker/profile.py",
    "scripts/broker_probe.py",
    "scripts/broker_report.py",
    "scripts/ftmo_universe.py",
    ...
    "execution_safety/guardian_bridge.py",
    "execution_safety/account_risk.py", "execution_safety/belief_reader.py",
