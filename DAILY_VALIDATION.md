...
- controller cycles logged today: **1069**
...
| no_trade_reasons_coded_pct | 97.7%  **<- FIX INFRASTRUCTURE** |
| rejections_explained_pct | 100.0% |

## No-trade summary

- `REGIME_MISMATCH` × 48809
- `OUTSIDE_WINDOW` × 44998
- `FIRST_BREAK_ALREADY_OCCURRED` × 10364
- `NO_BREAKOUT` × 6892
- `EVENT_BLACKOUT` × 4185
- `NO_SETUP` × 3719
- `UNMAPPED` × 2872
