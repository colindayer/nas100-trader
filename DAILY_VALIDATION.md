...
- controller cycles logged today: **1336**
...
| no_trade_reasons_coded_pct | 97.6%  **<- FIX INFRASTRUCTURE** |
| rejections_explained_pct | 100.0% |

## No-trade summary

- `REGIME_MISMATCH` × 49076
- `OUTSIDE_WINDOW` × 45532
- `FIRST_BREAK_ALREADY_OCCURRED` × 10670
- `NO_BREAKOUT` × 7386
- `EVENT_BLACKOUT` × 4185
- `NO_SETUP` × 3986
- `UNMAPPED` × 3139
