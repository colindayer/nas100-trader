...
- controller cycles logged today: **2652**
- cycle spacing: median 30s, max 120s (blind spot risk)
- last cycle: 58s ago
...
- `REGIME_MISMATCH` × 51271
- `OUTSIDE_WINDOW` × 48667
