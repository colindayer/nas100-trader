...
- controller cycles logged today: **1186**
...
| no_trade_reasons_coded_pct | 97.5%  **<- FIX INFRASTRUCTURE** |
| rejections_explained_pct | 100.0% |

## No-trade summary

- `REGIME_MISMATCH` × 63733
- `OUTSIDE_WINDOW` × 60394
- `FIRST_BREAK_ALREADY_OCCURRED` × 15169
- `NO_BREAKOUT` × 9995
- `EVENT_BLACKOUT` × 6640
- `NO_SETUP` × 5073
- `UNMAPPED` × 4355
- `ALREADY_TRADED_TODAY` × 3051
